...
const first = async () => {
    ...
    try {
        ...
        const calls = [
            {
                target: '0xBB947227A0998Fb76C911e4224DC3A19f9Bc488a',
                callData: accountContract.interface.encodeFunctionData("executeConditionalOrderWithPaymentReceiver", ['1', '0x3a10A18Ca6d9378010D446068d2Fd4dE5D272915']),
                allowFailure: false,
            },
            {
                target: '0xBB947227A0998Fb76C911e4224DC3A19f9Bc488a',
                callData: accountContract.interface.encodeFunctionData("executeConditionalOrderWithPaymentReceiver", ['0', '0x3a10A18Ca6d9378010D446068d2Fd4dE5D272915']),
                allowFailure: false,
            }
            // {
        ...
        if (staticCall) {
            console.log('staticCall 2', staticCall);
